import { HANDLE_JUMP_TAB_REQUEST, HANDLE_JUMP_TAB_CLEAR, HANDLE_TOAST_REQUEST, HANDLE_TOAST_CLEAR, SET_HANDLE_VIEW_DETAIL_COURSE, SET_HANDLE_VIEW_DETAIL_COURSE_CLEAR } from "./global-reducer";
